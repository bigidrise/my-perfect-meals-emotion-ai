...
const psychQuestions = [
    ...
    options: [
      {
        ...
        label: "I love structure—it helps me stay on track",
      },
      {
        value: "resist_structure",
        label: "I resist structure—I prefer flexibility",
      },
      {
  ...
  },
  {
    ...
    options: [
      { value: "very_confident", label: "Very confident—I just need a system" },
      {
        value: "somewhat_confident",
        label: "Somewhat confident—I need help sticking to it",
      },
      {
        value: "not_confident",
        label: "Not confident—I feel like nothing works for me",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        label: "Give me flexibility—I don't like being told what to do",
      },
      {
        value: "step_by_step",
        label: "Break it down step by step—I get overwhelmed",
      },
      { value: "create_plan", label: "Just create the plan—I'll follow it" },
      {
...
export default function ComprehensiveOnboarding() {
  ...
  const handleSave = async () => {
    setIsSaving(true);
    try {
      console.log("🔄 Saving onboarding step:", currentStep, "with data:", data);
      ...
      if (!response.ok) {
        ...
        console.error("❌ Save failed:", { status: response.status, errorText });
        throw new Error(
  ...
  useEffect(() => {
    const loadExistingProfile = async () => {
      try {
        ...
        console.log("ℹ️ No existing profile found or error loading:", error);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      sessionStorage.setItem("forceTop:/dashboard", "1");
  ...
  const autoGenerateWeeklyPlan = async (userData: any) => {
    ...
    try {
      ...
      console.log("✅ Auto-generated 7-day meal plan for new user");
    } catch (error) {
  ...
  const renderBodyType = () => (
    <div className="mt-6">
      ...
      <p className="text-sm text-white/80 mb-3">
        This tunes your carb/fat balance: <span className="font-medium">Ectomorph → more starch tolerant</span>, <span className="font-medium">Mesomorph → baseline</span>, <span className="font-medium">Endomorph → fewer starches</span>.
      </p>
      <RadioGroup
        value={data.bodyType}
      ...
      >
        {[
          { v: "ecto" as BodyType, title: "Ectomorph", sub: "Handles carbs well", badge: "Carbs ↑", bg: "bg-emerald-600", ring: "ring-emerald-300" },
          { v: "meso" as BodyType, title: "Mesomorph", sub: "Balanced baseline", badge: "Balanced", bg: "bg-indigo-600", ring: "ring-indigo-300" },
          { v: "endo" as BodyType, title: "Endomorph", sub: "Fewer starches work best", badge: "Starch ↓", bg: "bg-rose-600", ring: "ring-rose-300" },
        ].map((opt) => (
  ...
  const handleSaveProgress = () => {
    console.log("🔧 Manual save triggered:", { step: currentStep, formData: data });
      ...
      <Card className="w-full max-w-4xl mx-auto bg-black/40 backdrop-blur-md border-white/15">
        <CardHeader className="bg-gradient-to-br from-neutral-600 via-black/600 to-black text-white rounded-t-lg">
          ...
          <p className="text-white/90 mt-2">
            ...
            success. Answer honestly—there are no right or wrong answers.
          </p>
        </CardHeader>
        <CardContent className="p-8 space-y-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg mt-8">
            ...
            <ul className="text-white/90 space-y-2">
              <li>• Your daily experience (structured vs. flexible)</li>
              <li>• Meal reminders and nudges</li>
              <li>• Progress tracking or low-pressure coaching</li>
              <li>• Craving and dessert allowances</li>
              <li>
                • How we deliver support—gentle, firm, visual, or
                community-based
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg mt-4 border-l-4 border-white/30">
            <h3 className="font-semibold text-white mb-4">
              ✅ Psychological Frameworks & Citations
            </h3>
      ...
      <div className="max-w-6xl mx-auto">
        <Card className="w-full mx-auto bg-black/40 backdrop-blur-md border-white/15">
          ...
          <CardContent className="p-8 space-y-8">
            ...
            {/* Educational Content */}
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg border-l-4 border-white/30">
              <h3 className="font-semibold text-white mb-4">💡 How This Helps</h3>
              <ul className="text-white/90 space-y-2">
                <li>
                  • <strong>Avoided foods</strong> will never appear in your meal
                  plans
                </li>
                <li>
                  • Our AI considers your preferences when creating personalized
                  nutrition plans
                </li>
                <li>
        ...
        <Card className="w-full mx-auto bg-black/40 backdrop-blur-md border-white/15">
          ...
          <CardContent className="p-8 space-y-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg border-l-4 border-white/30">
              <h3 className="font-semibold text-white mb-4">💡 How This Helps</h3>
              <ul className="text-white/90 space-y-2">
                <li>• <strong>Low GI foods</strong> help maintain stable blood sugar levels</li>
                <li>• <strong>Mid GI foods</strong> provide balanced energy release</li>
                <li>• <strong>High GI foods</strong> are useful for quick energy but used sparingly</li>
                <li>• Your selections will prioritize appropriate carbs in meal recommendations</li>
              </ul>
            </div>
          </CardContent>
        </Card>
