...
export default function Learn() {
  ...
  const learningTopics: LearningTopic[] = [
    ...
    },
    {
      id: "how-to-videos",
      title: "How-To Videos",
      description: "Step-by-step guides for using My Perfect Meals",
      icon: Video,
      gradient: "from-orange-600/20 to-orange-500/20",
      content: {
        sections: [
          {
            heading: "Video Tutorial Library",
            text: "Access our complete collection of video tutorials covering app features, nutrition basics, and meal planning strategies.",
          },
          {
            heading: "Available Tutorials",
            list: [
              "Getting Started: Your first 7 days with My Perfect Meals",
              "Onboarding Guide: Setting up your profile and preferences",
              "Using the AI Meal Creator: Generate personalized meals",
              "Macro Calculator: Understanding and tracking your macros",
              "Weekly Meal Board: Planning your meals efficiently",
            ],
          },
          {
            heading: "Coming Soon",
            text: "New tutorial videos are added regularly. Check back often for the latest guides!",
          },
        ],
      },
    },
        ...
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-black/40 backdrop-blur-lg border border-white/10">
          ...
          {selectedTopic && (
            <div className="space-y-6 py-4">
              ...
              {/* How-To Videos Special Link */}
              {selectedTopic.id === "how-to-videos" && (
                <Button
                  onClick={() => {
                    handleCloseModal();
