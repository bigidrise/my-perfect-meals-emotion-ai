...
export default function DiabetesSupportPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-600 via-amber-600 to-yellow-600 relative">
            ...
            {readings.map((reading, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`text-xl font-bold ${inRange ? "text-green-200" : "text-red-200"}`}
                  >
                    {reading.value} mg/dL
                  </div>
                </div>
        ...
        <section className="bg-black/30 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8 relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-3 gap-6 relative z-10">
            ...
            <div className="bg-orange-500/20 backdrop-blur-sm rounded-xl p-6 border border-orange-400/30">
              <h3 className="text-white font-bold text-lg mb-3">Snack Ideas</h3>
              <ul className="text-white/90 space-y-2">
          ...
          <div className="mt-6 text-center relative z-10">
            <button
              ...
              className="px-8 py-4 rounded-xl bg-orange-500/90 backdrop-blur-sm hover:bg-orange-600/90 text-white font-bold transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1 border border-white/20 relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-transparent to-white/5 pointer-events-none" />
        ...
        <div className="flex justify-center gap-4 mt-8 relative z-10">
          <button
            onClick={() => setLocation("/diabetic")}
            className="flex items-center gap-2 px-6 py-3 rounded-xl bg-orange-500/90 backdrop-blur-sm hover:bg-orange-600/90 text-white border border-white/20 transition-all font-medium shadow-xl relative overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-transparent to-white/5 pointer-events-none" />
            <Home className="h-4 w-4 relative z-10" />
            <span className="relative z-10">Back to Diabetic Hub</span>
          </button>
        </div>

        {/* Enhanced Glass Floating Back to Top - Centered */}
        <button
