// 🔒 LOCKED FEATURE - DO NOT MODIFY without user approval
      ...
      >
        ...
        <div className="flex justify-center mt-8">
          <button
            ...
            className="bg-black/30 backdrop-blur-lg border border-white/20 hover:bg-black/40 shadow-xl hover:shadow-2xl transition-all duration-200 rounded-full p-3 text-white"
          >
